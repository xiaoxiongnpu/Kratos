...
int RansOmegaYPlusWallFunctionProcess::Check()
{
    ...
    rans_check_utilities.CheckIfVariableExistsInModelPart(r_model_part, TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE);
...
void RansOmegaYPlusWallFunctionProcess::Execute()
{
    ...
    const double omega = r_model_part.GetProcessInfo()[TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE];
    //const double nu_t_min = r_model_part.GetProcessInfo()[KINEMATIC_VISCOSITY];
    const double nu_m = r_model_part.GetProcessInfo()[KINEMATIC_VISCOSITY];
