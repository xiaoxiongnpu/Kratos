...
#include "custom_processes/solving_strategies/eddy_viscosity_co_solving_process.h"
...
void AddTrilinosSolvingProcessesToPython(pybind11::module& m)
{
    ...
    using MPIEddyViscosityCoSolvingProcessType =
        EddyViscosityCoSolvingProcess<MPISparseSpaceType, LocalSpaceType, MPILinearSolverType>;
    py::class_<MPIEddyViscosityCoSolvingProcessType, MPIEddyViscosityCoSolvingProcessType::Pointer, MPIScalarCoSolvingProcessType, Process>(
        m, "MPIEddyViscosityCoSolvingProcess")
        .def(py::init<ModelPart&, Parameters&>());
}
