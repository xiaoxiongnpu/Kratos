...
namespace Kratos
{
    ...
    KratosShallowWaterApplication::KratosShallowWaterApplication():
        ...
        mStupidElement2D3N(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3>>(Element::GeometryType::PointsArrayType(3)))),
    ...
    void KratosShallowWaterApplication::Register()
    {
        ...
        // Variables for explicit computations
        KRATOS_REGISTER_VARIABLE(RHS_MOMENTUM)
        KRATOS_REGISTER_VARIABLE(RHS_VELOCITY)
        KRATOS_REGISTER_VARIABLE(RHS_HEIGHT)
        ...
        KRATOS_REGISTER_ELEMENT("StupidElement2D3N", mStupidElement2D3N)
