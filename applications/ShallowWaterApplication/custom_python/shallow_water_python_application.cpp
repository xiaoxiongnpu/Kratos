...
namespace Python
{
  ...
  PYBIND11_MODULE(KratosShallowWaterApplication, m)
  {
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,RHS_MOMENTUM)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m,RHS_VELOCITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,RHS_HEIGHT)
