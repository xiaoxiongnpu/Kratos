...
KRATOS_CREATE_VARIABLE(double, TURBULENCE_RANS_SIGMA_K)
KRATOS_CREATE_VARIABLE(double, TURBULENCE_RANS_SIGMA_OMEGA)
KRATOS_CREATE_VARIABLE(double, TURBULENCE_RANS_GAMMA)
KRATOS_CREATE_VARIABLE(double, TURBULENCE_RANS_BETA_ZERO_STAR)
...
KRATOS_CREATE_VARIABLE(double, TURBULENCE_RANS_Y_PLUS_LIMIT_WALL)
// KRATOS_CREATE_VARIABLE( bool, TURBULENCE_BLENDING )
