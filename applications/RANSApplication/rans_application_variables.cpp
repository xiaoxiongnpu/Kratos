...
KRATOS_CREATE_VARIABLE(int, IS_EXTRACTION_ELEMENT)
...
KRATOS_CREATE_VARIABLE(Element*, PARENT_ELEMENT_POINTER)
KRATOS_CREATE_VARIABLE(Condition*, PARENT_CONDITION_POINTER)
