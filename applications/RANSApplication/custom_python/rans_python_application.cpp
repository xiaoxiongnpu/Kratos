...
PYBIND11_MODULE(KratosRANSApplication,m)
{
	...
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_SIGMA_K)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_SIGMA_OMEGA)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_GAMMA)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_BETA_ZERO_STAR)
	KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_BETA_ZERO)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_RANS_Y_PLUS_LIMIT_WALL)
    // KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENCE_BLENDING)
}
