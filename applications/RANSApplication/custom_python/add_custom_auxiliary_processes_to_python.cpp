...
#include "custom_processes/auxiliary_processes/rans_soft_max_scalar_variable_process.h"
...
void AddCustomAuxiliaryProcessesToPython(pybind11::module& m)
{
    ...
    using RansSoftMaxScalarVariableProcess = RansSoftMaxScalarVariableProcess;
    py::class_<RansSoftMaxScalarVariableProcess, RansSoftMaxScalarVariableProcess::Pointer, Process>(
        m, "RansSoftMaxScalarVariableProcess")
        .def(py::init<Model&, Parameters&>());
}
