...
#include "custom_processes/auxiliary_processes/rans_extract_elements_process.h"
...
void AddCustomAuxiliaryProcessesToPython(pybind11::module& m)
{
    ...
    using RansExtractElementsProcessType = RansExtractElementsProcess;
    py::class_<RansExtractElementsProcessType, RansExtractElementsProcessType::Pointer, Process>(
        m, "RansExtractElementsProcess")
        .def(py::init<Model&, Parameters&>());        
}
