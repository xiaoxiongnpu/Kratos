...
#ifndef KRATOS_RANS_EVM_K_OMEGA_OMEGA_WALL_BLENDED_H
#define KRATOS_RANS_EVM_K_OMEGA_OMEGA_WALL_BLENDED_H
...
/**
 * @brief Omega Neumann wall condition
 *
 * This is a Neumann wall condition for $\omega$ equation in $k-\omega$
...
class RansEvmKOmegaOmegaWallBlended : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of RansEvmKOmegaOmegaWallBlended
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(RansEvmKOmegaOmegaWallBlended);
    ...
    /** Admits an Id as a parameter.
      ...
      */
    explicit RansEvmKOmegaOmegaWallBlended(IndexType NewId = 0);
     ...
     */
    RansEvmKOmegaOmegaWallBlended(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    RansEvmKOmegaOmegaWallBlended(IndexType NewId, GeometryType::Pointer pGeometry);
     ...
     */
    RansEvmKOmegaOmegaWallBlended(IndexType NewId,
                               GeometryType::Pointer pGeometry,
                               PropertiesType::Pointer pProperties);

    /// Copy constructor.
    RansEvmKOmegaOmegaWallBlended(RansEvmKOmegaOmegaWallBlended const& rOther);

    /// Destructor.
    ~RansEvmKOmegaOmegaWallBlended() override;
    ...
    /// Assignment operator
    RansEvmKOmegaOmegaWallBlended& operator=(RansEvmKOmegaOmegaWallBlended const& rOther);

    ///@}
    ///@name Operations
    ///@{

    /// Create a new RansEvmKOmegaOmegaWallBlended object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
    ...
    /// Returns TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE for each node
    /**
    ...
    /// Returns TURBULENT_SPECIFIC_ENERGY_DISSIPATION_RATE_2 0 for each node
    /**
...
}; // Class RansEvmKOmegaOmegaWallBlended
...
inline std::istream& operator>>(std::istream& rIStream,
                                RansEvmKOmegaOmegaWallBlended<TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator<<(std::ostream& rOStream,
                                const RansEvmKOmegaOmegaWallBlended<TNumNodes>& rThis)
{
...
#endif // KRATOS_RANS_EVM_K_OMEGA_OMEGA_WALL_H
