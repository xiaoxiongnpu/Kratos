...
#define KRATOS_RANS_EVM_K_OMEGA_OMEGA_WALL_H
...
class RansEvmKOmegaOmegaWall : public Condition
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of RansEvmKOmegaOmegaWall
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(RansEvmKOmegaOmegaWall);
    ...
    /** Admits an Id as a parameter.
      ...
      */
    explicit RansEvmKOmegaOmegaWall(IndexType NewId = 0);
     ...
     */
    RansEvmKOmegaOmegaWall(IndexType NewId, const NodesArrayType& ThisNodes);
     ...
     */
    RansEvmKOmegaOmegaWall(IndexType NewId, GeometryType::Pointer pGeometry);
     ...
     */
    RansEvmKOmegaOmegaWall(IndexType NewId,
                               GeometryType::Pointer pGeometry,
                               PropertiesType::Pointer pProperties);

    /// Copy constructor.
    RansEvmKOmegaOmegaWall(RansEvmKOmegaOmegaWall const& rOther);

    /// Destructor.
    ~RansEvmKOmegaOmegaWall() override;
    ...
    /// Assignment operator
    RansEvmKOmegaOmegaWall& operator=(RansEvmKOmegaOmegaWall const& rOther);

    ///@}
    ///@name Operations
    ///@{

    /// Create a new RansEvmKOmegaOmegaWall object.
    /**
      @param NewId Index of the new condition
      @param ThisNodes An array containing the nodes of the new condition
      @param pProperties Pointer to the element's properties
...
inline std::istream& operator>>(std::istream& rIStream,
                                RansEvmKOmegaOmegaWall<TNumNodes>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator<<(std::ostream& rOStream,
                                const RansEvmKOmegaOmegaWall<TNumNodes>& rThis)
{
