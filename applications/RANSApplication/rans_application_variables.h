...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, TURBULENCE_RANS_Y_PLUS_LIMIT_WALL)
// KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, bool, TURBULENCE_BLENDING)
} // namespace Kratos
