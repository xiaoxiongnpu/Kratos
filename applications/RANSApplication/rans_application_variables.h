...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, int, IS_EXTRACTION_ELEMENT)
...
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, double, FRICTION_VELOCITY)
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Element*, PARENT_ELEMENT_POINTER)
KRATOS_DEFINE_APPLICATION_VARIABLE(RANS_APPLICATION, Condition*, PARENT_CONDITION_POINTER)
