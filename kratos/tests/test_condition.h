...
#if !defined(KRATOS_TEST_CONDITION_H_INCLUDED )
#define  KRATOS_TEST_CONDITION_H_INCLUDED
...
namespace Kratos
{
    ...
    */
    ...
    public:
        ...
        ///@name Type Definitions
        ///@{
        /// Counted pointer of TestCondition
        KRATOS_CLASS_POINTER_DEFINITION( TestCondition);
        ///@}
        ...
        */
        TestCondition(IndexType NewId, GeometryType::Pointer pGeometry, const ResidualType TheResidualType = ResidualType::LINEAR);
        ...
        * @param TheResidualType The problem to be solved (linear, non-linear, arc-length ...)
        */
        TestCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties, const ResidualType TheResidualType = ResidualType::LINEAR);

        ///Copy constructor
        TestCondition(TestCondition const& rOther);
        ...
        /// Assignment operator.
        TestCondition& operator=(TestCondition const& rOther);
...
#endif // KRATOS_TEST_CONDITION_H_INCLUDED  defined 
